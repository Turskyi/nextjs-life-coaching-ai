  ...
  return (
    <main className="flex h-screen flex-col items-center justify-center gap-5">
      ...
      <p className="max-w-prose text-center">
        Discover your true potential with AI-powered life-coaching app. Set and
        achieve your goals with personalized guidance and insightful questions
        designed to help you find your own answers.
      </p>
